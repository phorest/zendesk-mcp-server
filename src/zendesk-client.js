...
class ZendeskClient {
  getConfig() {
    ...
    if (!subdomain || !email || !apiToken) {
      throw new Error('Zendesk credentials not configured. Please set ZENDESK_SUBDOMAIN, ZENDESK_EMAIL, and ZENDESK_API_TOKEN.');
    }
  ...
  getBaseUrl() {
    return `https://${this.getConfig().subdomain}.zendesk.com/api/v2`;
  }
