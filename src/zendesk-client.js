...
export class ZendeskClient {
  constructor({ subdomain, email, apiToken }) {
    ...
    if (!this.subdomain || !this.email || !this.apiToken) {
      throw new Error('Zendesk credentials are required: subdomain, email, and apiToken.');
    }
  }
  ...
  async deleteUser(id) { return this.request('DELETE', `/users/${id}.json`); }

  async listOrganizations(params) { return this.request('GET', '/organizations.json', null, params); }
  async getOrganization(id) { return this.request('GET', `/organizations/${id}.json`); }
  ...
  async listGroups(params) { return this.request('GET', '/groups.json', null, params); }
  ...
  async getMacro(id) { return this.request('GET', `/macros/${id}.json`); }
